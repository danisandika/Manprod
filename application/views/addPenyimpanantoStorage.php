        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: 13px">
                ...
                <tr>
                    ...
                    <td>
                    <a title="Simpan ke Storage"  href="<?php echo site_url('TransaksiPenyimpanan/addTransaksiPenyimpanantoStorage/'.$item->id_barang); ?>"><span class="btn btn-xs btn-teal tooltips"><i
