            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: 13px">
                    ...
                    <tr>
                        ...
                        <td>
                        <a title="Transaksi diambil" onclick="ambilConfirm('<?php echo base_url('KelolaTransaksiAmbil/statusAmbil/'.$item->id_trx) ?>')" href="#"><span class="btn btn-xs btn-teal tooltips"><i class="fa fa-check"></i></span></a>
